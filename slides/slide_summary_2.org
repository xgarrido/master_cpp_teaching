...
#+BEGIN_SRC c++
  ...
  public:
    ...
    void set_spin(const double spin_);
...
#+BEGIN_SRC c++
  ...
  public:
    particule();
    particule(const double spin_, const double charge_);
    ~particule();
...
#+BEGIN_SRC c++
  ...
  particule::particule() :
    m_spin(0.0), m_charge(0.0)
  {
  }

  // Surdéfinition du constructeur
  particule::particule(const double spin_, const double charge_)
    : m_spin(spin_), m_charge(charge_)
  {
  }
...
** Fichier =particule.cc=
#+BEGIN_SRC c++
  double particule::get_spin() const
  {
    return m_spin;
  }
  ...
  void particule::set_spin(const double spin_)
  {
    m_spin = spin_;
  }
...
#+BEGIN_SRC c++
  ...
  int main()
  {
    particule my_particule1(1/2., 1.6e-19);
