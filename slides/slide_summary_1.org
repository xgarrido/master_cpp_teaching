...
- Les macros telles qu'utilisées en C sont à éviter (/cf./ [[https://isocpp.org/wiki/faq/inline-functions#inline-vs-macros][evil#1]], [[https://isocpp.org/wiki/faq/misc-technical-issues#macros-with-if][evil#2]],
  [[https://isocpp.org/wiki/faq/misc-technical-issues#macros-with-multi-stmts][evil#3]], [[https://isocpp.org/wiki/faq/misc-technical-issues#macros-with-token-pasting][evil#4]]). Les seules véritables directives de préprocesseur à
