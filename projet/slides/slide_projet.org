    ...
    \begin{tikzpicture}
      ...
      \node (tbl) {
        \begin{tabularx}{\textwidth}{rXr}
          ...
          19 -- 23 Janvier & Indication aux enseignants du projet choisi (via formulaire web) \\[2ex]
          9 -- 13 Mars    & Remise des programmes \textbf{par mail} à \\
          &\href{xavier.garrido@u-psud.fr}{\color{blue}\ding{41}~xavier.garrido@u-psud.fr} ou\\
          &\href{hermes.belusca@th.u-psud.fr}{\color{blue}\ding{41}~hermes.belusca@th.u-psud.fr} \\
          & Remise des rapports au Secrétariat \\[2ex]
          %% 19 Mars à 12h     & Affichage des plannings de soutenances \\[2ex]
          30 Mars -- 3 Avril     & Soutenances de projet informatique \\[2ex]
      \end{tabularx}};
