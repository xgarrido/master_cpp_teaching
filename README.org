...
| annexe_compilation         | A. Compilation et directives de préprocesseur            |
| annexe_convention_ecriture | B. Convention d'écrciture et organisation des programmes |
|----------------------------+----------------------------------------------------------|
...
#+BEGIN_SRC sh :tangle no :results output
  ...
  do
      if [[ $f == *lecture_* ]]; then
          ...
          preamble+='<span><a href=\"'$f'.html\">'$i'. '
          let i=i+1
      elif [[ $f == *annexe_* ]]; then
          preamble+='<span><a href=\"'$f'.html\">'
      else
          preamble+=$f' '
      fi
  done
