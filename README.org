...
#+BEGIN_SRC sh :tangle no :results output
  ...
  do
      if [ $f == '+' ]; then
          ...
          preamble+='<aa>'
          tag=false
      elif [[ $f == *lecture_* || $f == *slide_* ]]; then
          if $tag; then preamble+=$f'.html\">';fi
      elif [[ $f == *annexe_* ]]; then
          if $hr; then preamble+='<hr/>';fi
          if $tag; then preamble+=$f'.html\">';fi
          hr=false
      else
          preamble+=$f' '
  ...
  if $tag; then preamble+='</a>';fi
  echo -ne $preamble
#+END_SRC
*** Building index page
:PROPERTIES:
:TANGLE: doc/index.html
:END:
#+BEGIN_SRC html
  ...
  <html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    ...
    <body>
      <div id="preamble" class="status">
        <a href="./lectures/lecture_pointeur.html">Fiches C++<small>Cours écrits</small></a>
        <a href="./lectures/lecture_pointeur.html">Transparents C++<small>Présentations orales</small></a>
        <a href="./lectures/lecture_pointeur.html">Travaux Dirigés<small>Exercices de C++</small></a>
      </div>
      <div id="content">
        ...
        <p>
          ...
          <li><a href="./lecture/lecture_pointeur.html">un cours écrit sous forme de fiche</a></li>
          <li><a href="./lecture/lecture_pointeur.html">les transparents de cours</a></li>
          <li><a href="./lecture/lecture_pointeur.html">un ensemble d'exercices</a></li>
        </p>
        ...
        <p>
          ...
          enrichies par, successivement, <a href="mailto:xavier.garrido@upsud.fr">Xavier
