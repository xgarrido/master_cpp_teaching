  ...
  <html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    ...
    <body>
      <div id="preamble" class="status">
        ...
        <a href="./slides/slide_compilation.html">Transparents C++<small>Présentations orales</small></a>
        <a href="./td/td_pointeur_fonction.html">Travaux Dirigés<small>Exercices de C++</small></a>
      </div>
      <div id="content">
        ...
        <p>
          ...
          <li><a href="./lectures/lecture_pointeur.html">un cours écrit sous forme de fiche</a></li>
          <li><a href="./slides/slide_compilation.html">les transparents de cours</a></li>
          <li>les transparents de cours</li>
          <li><a href="./td/td_pointeur_fonction.html">un ensemble d'exercices</a></li>
        </p>
